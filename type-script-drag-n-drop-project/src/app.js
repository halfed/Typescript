...
;
class Project {
    constructor(id, title, description, people, jobDescription, status) {
        this.id = id;
        this.title = title;
...
class ProjectState extends State {
    ...
    addProject(title, description, numOfPeople, jobDescription) {
        const newProject = new Project(Math.random().toString(), title, description, numOfPeople, jobDescription, ProjectStatus.Active);
...
class ProjectInput extends Component {
    constructor() {
        ...
        this.jobDescriptionInputElement = this.element.querySelector('#jobDescription');
        this.configure();
    }
    configure() {
    ...
    gatherUserInput() {
        ...
        const jobDescriptionValidatable = {
